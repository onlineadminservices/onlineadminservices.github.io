  ...
  return (
    <>
      ...
      <a
        ...
        title="Vista previa del listing Amazon (uso interno)"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-gray-900 text-white text-xs font-medium px-4 py-2 rounded-full shadow-lg opacity-50 hover:opacity-100 transition-opacity duration-200"
      >
        🛍️ Listing Preview
      </a>
    </>
