          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-10">
            {features.map((feat, i) => (
              <div key={i} className="group">
                <div className="rounded-2xl overflow-hidden mb-5 md:mb-7 bg-[#252525]" style={{ aspectRatio: '4/3' }}>
                  <img
                    src={feat.img}
                    alt={feat.title}
                ...
                <h3 className="text-white text-base font-medium mb-2 md:mb-2.5 tracking-wide">{feat.title}</h3>
